...
:bulb: This npm module will use your own custom rules to lint an HTML page and make sure it follows your HTML/CSS conventions (classes, attributes, tags types, structure etc.)
